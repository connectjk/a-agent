...
def deploy():
    ...
    payload = json.dumps({
        "name": sanitize_name("a_agent"),
        "description": """A Car Insurance Policy agent that can search our knowledge base, Provide a Car insurance related information""",
        "definition": {
            "kind": "prompt",
            "model": "gpt-4o",
            "instructions": """A Car Insurance Policy agent that can search our knowledge base, Provide a Car insurance related information"""
        }
    }).encode()
